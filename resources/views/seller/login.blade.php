    ...
    <div class="login-container">
        <div class="brand-header">
            <div class="brand-icon">
                <img src="{{ asset('images/logo_ulayya.png') }}" alt="Ulayya Logo">
            </div>
        ...
        <div class="card">
            ...
            <form method="POST" action="{{ route('seller.authenticate') }}">
                @csrf
                <div class="form-group">
                    <label for="email">Email</label>
                    <div class="input-wrapper">
                        <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg>
                        <input id="email" type="email" name="email" class="input-field" value="{{ old('email') }}" placeholder="admin@ulayya.com" required autocomplete="email" autofocus>
                    </div>
                </div>
